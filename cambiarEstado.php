...
<main>
  ...
  <ul id="dropdown1" class="dropdown-content">
    ...
    <li class=""><a href="/profesorDashboard.php">Profesor</a></li>
  </ul>
    ...
    <div class="row">
      <div class="col s12 l9 ">
        ...
        <form action="cambiarEstadoForm.php" method="POST">
          <div class="input-field col s12 l9">
            ...
            <input type="text" class="form-control" name="idmision">
      ...
      <div class="col s12 l3">
        <div class="collection">
          ...
          <a class="collection-item active" href="/cambiarEstado.php">Cambiar Estado</a>
